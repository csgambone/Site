class DblessCatchRate
	include ActiveModel::Validations
	include ActiveModel::Conversion
	extend ActiveModel::Naming

	attr_accessor :catchrate, :currenthp, :maxhp, :status, :ball, :opower, :caught, :repeat, :turn_number, :enemy_level, :bug_water_type, :dive_surf_fish, :cave_night
